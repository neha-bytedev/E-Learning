    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-600">
          ...
          <p
            className="pt-4 md:text-base-sm"
          ...
          <p className="text-sm">
            {" "}
            Course by{" "}
            <span className="text-blue-500 underline">Tech2Skill</span>
          </p>
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index) => (
                ...
                >
                  ...
                  >
                    <ul className="list-disc md:pl-10 pl-14 pr-4 py-2 text-gray-6-- border-t border-gray-300">
